...
public class HouseController {
    ...
    public ResponseDto<HouseInfoListDto> searchAptMap(@PathVariable("dongCode") String dongCode){
    ...
    public ResponseDto<HouseInfoListDto> searchOfficetelMap(@PathVariable("dongCode") String dongCode){
    ...
    public ResponseDto<HouseOnSaleVillaMapDto> searchOneRoomMap(@PathVariable("dongCode") String dongCode){
    ...
    public ResponseDto<HouseOnSaleVillaMapDto> searchTwoRoomMap(@PathVariable("dongCode") String dongCode){
    ...
    public ResponseDto<HouseOnSaleListDto> getAptOnSaleList(@PathVariable("houseInfoId") Long houseInfoId){
    ...
    public ResponseDto<HouseOnSaleListDto> getOfficetelOnSaleList(@PathVariable("houseInfoId") Long houseInfoId){
        return ResponseDto.res(ResponseCode.OK, houseService.getHouseOnSale(houseInfoId));
    }
    ...
    public ResponseDto<HouseOnSaleVillaListDto> getOneRoomOnSaleList(@PathVariable("zoneCode") String zoneCode){
    ...
    public ResponseDto<HouseOnSaleVillaListDto> getTwoRoomOnSaleList(@PathVariable("zoneCode") String zoneCode){
    ...
    public ResponseDto<HouseOnSaleDetailDto> getOnSaleDetail(@PathVariable("houseOnSaleId") Long houseOnSaleId){
    ...
    public ResponseDto<HouseOnSaleVillaDetailDto> getOnSaleVillaDetail(@PathVariable("houseOnSaleVillaId") Long houseOnSaleVillaId){
