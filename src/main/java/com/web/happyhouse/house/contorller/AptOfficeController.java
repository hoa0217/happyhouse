...
public class AptOfficeController {
    ...
    public ResponseDto<Long> createHouseOnSale(
            ...
            @Valid HouseOnSaleCreateRq createRq){
    ...
    @PatchMapping("/update")
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "CREATED 오피스텔/아파트 매물업데이트를 완료했습니다."),
    ...
    public ResponseDto<Long> updateHouseOnSale(
            ...
            @Valid HouseOnSaleUpdateRq updateRq){
    ...
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "CREATED 오피스텔/아파트 매물삭제를 완료했습니다."),
            @ApiResponse(code = 400, message = "BAD_REQUEST 선택한 아파트/오피스텔매물 찾기를 실패했습니다.")
    })
    @ResponseStatus(HttpStatus.OK)
